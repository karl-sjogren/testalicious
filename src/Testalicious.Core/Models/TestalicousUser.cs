...
namespace Testalicious.Core.Models {
    public class TestaliciousUser {
        public TestaliciousUser() {
        ...
        public virtual void AddLogin(UserLoginInfo login) {
            Logins.Add(new IdentityUserLogin<string>(login, ));
        }
        ...
        public virtual void AddClaim(Claim claim) {
            Claims.Add(new IdentityUserClaim<string>(claim));
        }
        ...
        public override string ToString() => $"TestaliciousUser<{UserName}, {Id}>";
    }
}